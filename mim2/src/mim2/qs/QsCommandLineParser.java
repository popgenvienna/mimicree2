...
public class QsCommandLineParser {
	...
	public static void printHelpMessage()
	{
		...
		sb.append("java -jar mim2.jar qff --haplotypes-g0 basepop.mimhap.gz --effect-size mysnps.txt --snapshots 25,50,100 --fitness-function gaussian.txt --heritability 0.8 --output-sync simresults.sync\n\n");
		sb.append("Mandatory parameters:\n");
		sb.append(CommandFormater.format("--haplotypes-g0","the haplotype file",null));
		sb.append(CommandFormater.format("--fitness-function","a fitness function for mapping the phenotype to fitness",null));
