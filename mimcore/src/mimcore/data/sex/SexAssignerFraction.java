 ...
 */
public class SexAssignerFraction implements ISexAssigner {
    ...
    public SexAssignerFraction (double maleFraction, double femaleFraction, double hermaphroditeFraction, int minCount)
    {
    ...
    {
        if(Math.abs(maleFraction-1.0)<0.000000001) return false;
        if(Math.abs(femaleFraction-1.0)<0.000000001) return false;
        return true;
    }
