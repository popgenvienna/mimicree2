 ...
 */
public class FitnessFunctionQuantitativeGauss implements IFitnessCalculator {
	...
	public FitnessFunctionQuantitativeGauss(double minFitness, double maxFitness, double mean, double stdev)
	{
