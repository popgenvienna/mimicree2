	...
	public FitnessFunctionContainer readFitnessFunction()
	{
		...
		try
		{
			while((line=bf.readLine())!=null)
			{
				...
				if(a.length!=5) throw new IllegalArgumentException("Every entry in the diminishing returns epistasis fitness function file must have exactly five columns (tab separated)");
