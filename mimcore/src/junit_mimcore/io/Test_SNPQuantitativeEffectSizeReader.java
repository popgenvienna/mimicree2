...
public class Test_SNPQuantitativeEffectSizeReader {
	...
	{
		ArrayList<AdditiveSNPeffect> s= getReader().readAdditiveFitness().getAdditiveSNPeffects();
	...
	public void effect_of_first_SNP_in_file()
	{
		...
		char[] geno={'C','C'};
		assertEquals(s.get(0).getEffectSizeOfGenotype(geno),2.0,0.0000001);

		char[] geno1={'C','A'};
		assertEquals(s.get(0).getEffectSizeOfGenotype(geno1),1.1,0.000001);

		char[] geno2={'A','A'};
		assertEquals(s.get(0).getEffectSizeOfGenotype(geno2),-2.0,0.000001);
	...
	public void effect_of_last_SNP_in_file()
	{
		...
		char[] geno={'G','G'};
		assertEquals(s.get(3).getEffectSizeOfGenotype(geno),2.3,0.0000001);

		char[] geno1={'C','G'};
		assertEquals(s.get(3).getEffectSizeOfGenotype(geno1),1.4,0.000001);

		char[] geno2={'C','C'};
		assertEquals(s.get(3).getEffectSizeOfGenotype(geno2),-2.3,0.000001);
